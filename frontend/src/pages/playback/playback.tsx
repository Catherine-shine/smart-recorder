...
import ProgressBar from '../../components/playback/progressBar/progressBar';
import VolumeControl from '../../components/playback/volumeControl/volumeControl';
import { Card, Row, Col, message } from 'antd';
import React, { useState, useRef, useEffect } from "react";
import PlaybackRate from "../../components/playback/playBackRate/playBackRate";
import './index.css';
     ...
     <div className="playback-container">
      <div className="playback-content">
        <Card
          ...
          headStyle={{ 
            textAlign: 'center', 
            fontSize: 20, // 移动端减小标题字体
            fontWeight: 'bold',
            padding: '12px 0' // 优化标题内边距
          }}
        >
          {/* 视频容器 */}
          ...
          <div className="playback-controls-parent">
            <Row
              gutter={[12, 16]} // 大屏间距，移动端通过CSS覆盖
              align="middle"
              wrap={true} // 强制移动端换行
              className="playback-controls"
            >
              {/* 播放按钮：移动端（xs）占6列，平板（sm）占4列，大屏（md）占2列 */}
              <Col xs={6} sm={4} md={2}>
                <PlayButton
              ...
              {/* 音量控制：移动端（xs）占6列，平板（sm）占5列，大屏（md）占3列 */}
